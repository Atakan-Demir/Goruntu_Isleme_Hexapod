...
{
  if (sec == 1)  //stop & select gait 0   (ps2x.ButtonPressed(PSB_PAD_DOWN))
  {
    mode = 0;
    gait = 0;
    reset_position = true;
  ...
  if (ps2x.ButtonPressed(PSB_PAD_LEFT))   //stop & select gait 1   (ps2x.ButtonPressed(PSB_PAD_LEFT))
  {
    mode = 0;
    gait = 1;
    reset_position = true;
  ...
  if  (ps2x.ButtonPressed(PSB_PAD_UP))    //stop & select gait 2  (ps2x.ButtonPressed(PSB_PAD_UP))
  {
    mode = 0;
    gait = 2;
    reset_position = true;
  ...
  if (ps2x.ButtonPressed(PSB_START))      //change gait speed   (ps2x.ButtonPressed(PSB_START))
  {
    if (gait_speed == 0)
      gait_speed = 1;
    else
